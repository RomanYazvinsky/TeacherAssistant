...
namespace TeacherAssistant.Pages.GroupTablePage
{
    public class GroupTableModel : AbstractModel<GroupTableModel>
    {
        ...
        public GroupTableModel(LocalDbContext db, WindowComponentHost host)
        {
            _db = db;
            _host = host;
        ...
        {
            _host.AddPageAsync(new GroupFormToken(this.SelectedGroupEntity.Name, this.SelectedGroupEntity));
        }
        ...
        [Reactive]
        public GroupEntity SelectedGroupEntity { get; set; }
